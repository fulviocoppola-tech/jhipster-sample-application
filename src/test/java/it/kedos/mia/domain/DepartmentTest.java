package it.kedos.mia.domain;

import static it.kedos.mia.domain.DepartmentTestSamples.*;
import static it.kedos.mia.domain.EmployeeTestSamples.*;
import static it.kedos.mia.domain.JobHistoryTestSamples.*;
import static it.kedos.mia.domain.LocationTestSamples.*;
import static org.assertj.core.api.Assertions.assertThat;

import it.kedos.mia.web.rest.TestUtil;
